...
public class E2ETestConfiguration {
  ...
  public DataSource e2eTestDataSource() {
    ...
    return DataSourceBuilder.create()
        .url(container.getJdbcUrl() + "&currentSchema=e2e_test")
  ...
  @Bean
  @Primary
  public SqlSessionFactory e2eTestSqlSessionFactory(DataSource dataSource) throws Exception {
  ...
  @Bean
  @Primary
  public SqlSessionTemplate e2eTestSqlSessionTemplate(SqlSessionFactory sqlSessionFactory) {
